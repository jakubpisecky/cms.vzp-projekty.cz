...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $isBlockPagePost = in_array(
        $template,
        ['home', 'universal'],
        true
    );

    $content = $isBlockPagePost
        ? ''
        : ($_POST['content'] ?? '');
    ...
    if ($msg === '') {
        ...
        /*
         * Stránka nemůže být sama sobě rodičem.
         */
        if ($parent_id === $id) {
            $parent_id = 0;
        }
        ...
        /*
         * Kontrola unikátního slugu v rámci rodiče.
         */
        $chk = $conn->prepare("
            SELECT id
            FROM pages
        ...
        $u = $conn->prepare("
            ...
            SET
                ...
                status = ?,
                template = ?,
                sidebar_navigation_id = NULLIF(?, 0),
                published_at = IF(
                    ? = 'published'
    ...
    /*
     * Zachování hodnot formuláře při chybě.
     */
    ...
    $page['sidebar_navigation_id'] = $sidebar_navigation_id;
        ...
        <div class="col-md-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <?php if ($isBlockPage): ?>
                    ...
                    <a
                        href="blocks.php?page_id=<?= (int)$page['id'] ?>"
            ...
            <?php if ($isBlockPage): ?>
                ...
                <div class="alert alert-info">
                    ...
                    Tato stránka se skládá z bloků.
                    Obsah stránky upravíte přes tlačítko
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-8">
                        ...
                        >
                            ...
                            <?php foreach ($navigationOptions as $navigation): ?>

                                <option
                                    value="<?= (int)$navigation['id'] ?>"
                                    <?= (int)($page['sidebar_navigation_id'] ?? 0)
                                        === (int)$navigation['id']
                                        ? 'selected'
                                        : '' ?>
                                >
                                    <?= htmlspecialchars($navigation['name']) ?>
                                </option>
                        ...
                        <div class="form-text">
                            Vybraná navigace se zobrazí v levém sloupci stránky.
                        </div>
